...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script> -->
  <title>Lhiving</title>
  <meta name="Description" content="Vzw Lhiving wil psychosociale hulp bieden aan mensen met hiv of een andere chronische ernstige ziekte die zich in een kansarme situatie bevinden, en aan hun gezin.">
  <meta name="theme-color" content="#ffffff">
</head>
<body>
    <header class="header">
    <nav class="navbar navbar-expand-md header__navbar container">
    <a class="navbar-brand" href="index.php"><img src="assets/img/logo.gif" alt="Lhiving logo" class="header__logo"></a>
